...
const help = [
  ...
  <p>Si no aparecen los datos de tu pareja, rellena por favor las casillas indicadas.</p>
`,
];
...
const DatosPareja = () => {
  ...
  const onSubmit = async (data: any) => {
    insertAnswer({
      ...
      groupKey: "datospareja",
      groupNextKey: "inscritaparejaregistrocivil",
      properties: [
        {
          propertyKey: "name",
    ...
    setCurrentQuestion("inscritaparejaregistrocivil");
  };

  return (
    <ComplexSectionBloc>
      <HeaderSection title="Pon los datos de tu pareja" hasActions>
        <button
