...
const FormularioBlog: NextPageWithLayout = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <Head>
        <title>Formulario de captación de leads blog</title>
          ...
          >
            ...
            <div className="sm:col-span-2">
              ...
              >
                ...
                <option>Entre 5.000€ y 15.000€</option>
              </select>
            </div>
...
FormularioBlog.getLayout = function getLayout(page: ReactElement) {
