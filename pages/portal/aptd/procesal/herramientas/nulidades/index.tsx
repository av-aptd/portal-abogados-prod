...
const Nulidad: NextPageWithLayout = () => {
  const router = useRouter();

  const processExcel = async () => {
    router.push("nulidades/resultado");
  };
  ...
  return (
    <div className="py-6 mx-auto max-w-7xl">
      <SectionBloc
        title="Nulidades"
        description="Subir archivo para las nulidades"
      >
        <ExcelUploader />
...
Nulidad.getLayout = function getLayout(page: ReactElement) {
  return <PortalLayout>{page}</PortalLayout>;
};

export default Nulidad;
