...
const Venias: NextPageWithLayout = () => {
  const router = useRouter();

  const processExcel = async () => {
    router.push("venias/resultado");
  };

  return (
    <div className="py-6 mx-auto max-w-7xl">
      <SectionBloc title="Venias" description="Subir archivo de venias">
        <ExcelUploader />
...
Venias.getLayout = function getLayout(page: ReactElement) {
  return <PortalLayout>{page}</PortalLayout>;
};

export default Venias;
