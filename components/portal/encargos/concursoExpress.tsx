...
const EncargoConcursoExpress = ({ onSubmit }: any) => {
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="prose max-w-none">
      ...
      <div className="mx-auto max-w-4xl text-gray-500 bg-white p-8 rounded-lg border mb-8">
        ...
        <p>
          ...
          <strong>{lead.phone}</strong>, actuando en nombre y representación de
          la mercantil <strong>{lead.businessName}</strong>, con CIF{" "}
          <strong>{lead.businessCIF}</strong>, y domicilio en{" "}
          <strong>{lead.businessAddress}</strong> (en adelante el{" "}
        ...
        <ol>
          <li>
            Para aquellos concursos en los que el CLIENTE no tenga bienes a su
            nombre, o éstos sean de escaso valor, o bien se excluya la vivienda
            habitual del CLIENTE por cumplir con los requisitos que a
            continuación se indican, se fijan en 110€ + 21% IVA, esto es 133,10
            euros.
          </li>
          <li>
            Para aquellos concursos en los que el CLIENTE si disponga de bienes,
            se fijan en 250€+21% IVA, esto es, 302,50 euros.
          </li>
        </ol>
        <p>
...
export default EncargoConcursoExpress;
