...
const FormularioHome: NextPageWithLayout = () => {
        ...
        {!mutation.isSuccess ? (
          ...
          >
            ...
            <div className="sm:col-span-2 pb-4">
              ...
              <div className="flex items-center justify-between border bg-white rounded-md border-gray-300 py-2 px-3">
                <p className=" text-gray-700 sm:text-sm">Sí. Llamadme ahora</p>
                ...
                <div className="flex-shrink-0">
                  <Switch
                    ...
                    onChange={setCallNow}
                    className={clsx(
                      callNow ? "bg-secondary" : "bg-gray-200",
                      "relative inline-flex mt-1 h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-secondary focus:ring-offset-2"
                    )}
                  >
                    ...
                    <span
                      aria-hidden="true"
                      className={clsx(
                        callNow ? "translate-x-5" : "translate-x-0",
...
FormularioHome.getLayout = function getLayout(page: ReactElement) {
