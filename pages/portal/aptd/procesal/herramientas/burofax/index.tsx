...
const Burofax: NextPageWithLayout = () => {
  const router = useRouter();

  const processExcel = async () => {
    router.push("burofax/resultado");
  };

  return (
    <div className="py-6 mx-auto max-w-7xl">
      <SectionBloc title="Burofax" description="Subir archivo para los burofax">
        <ExcelUploader />
...
Burofax.getLayout = function getLayout(page: ReactElement) {
  return <PortalLayout>{page}</PortalLayout>;
};

export default Burofax;
